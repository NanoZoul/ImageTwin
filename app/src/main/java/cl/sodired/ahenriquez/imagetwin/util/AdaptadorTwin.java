...
public class AdaptadorTwin extends ArrayAdapter<ItemTwin> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Picasso.with(context).load("http://192.168.0.14:8181/" + itemTwin.imagenUsuario).resize(600,600).transform(new CircleTransform()).centerCrop().into(imagen0);
        Picasso.with(context).load("http://192.168.0.14:8181/" + itemTwin.imagenPareja).resize(600,600).transform(new CircleTransform()).centerCrop().into(imagen1);
